...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-900 shadow-2xl">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/admin/profile" class="flex items-center p-2 rounded-lg text-white hover:bg-zinc-50 hover:text-black">
                    <img src="/img/user.png" class="h-6 mr-1 sm:h-6" alt="Flowbite Logo" />
                    <span class="flex-1 ml-3 whitespace-nowrap">Profile</span>
                </a>
            </li>
            <li>
                <a href="/admin" class="flex items-center p-2 rounded-lg text-white hover:bg-zinc-50 hover:text-black">
                    <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6  transition duration-75 text-yellow-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
