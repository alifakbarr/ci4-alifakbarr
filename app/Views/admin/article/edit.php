        ...
        <div class="relative overflow-x-auto">
            <form action="/admin/article/update/<?= $article['id'] ?>" method="post">
                ...
                <div>
                    ...
                    <input type="text" id="title" value="<?= $article['title'] ?>" class="bg-white text-black text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5" placeholder="Insert title here..." required name="title">
                </div>
                <div>
                    <label for="content" class="block mb-2 text-normal font-medium text-white">Content</label>
                    <textarea id="editor" rows="4" class="block p-2.5 w-full text-sm text-black bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..." name="content"><?= $article['content'] ?></textarea>
                </div>
