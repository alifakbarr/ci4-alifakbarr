...
<div class="mt-5 mb-28 px-8 sm:px-12 rounded-lg">
    <a href="/admin/category/create" class="text-black bg-yellow-500 border border-black font-medium rounded-lg text-base px-4 py-1.5 text-center mr-2 mb-2">Create</a>
