...
<div class="pt-10 sm:pt-20 pb-10 px-8">
    <div class="text-center">
        <p class="text-4xl sm:text-4xl w-full tracking-tighter shadow-lg leading-tight font-bold text-white pb-9">About Me</p>
        <div class="flex justify-center items-center">
            <img src="img/creative.png" alt="Gambar Tengah" class="h-20">
        </div>
        <p class="text-4xl sm:text-5xl w-full tracking-tight shadow-lg leading-tight font-bold text-white py-3">CreativityCove</p>
        <p class="text-base sm:text-base w-full tracking-tighter shadow-lg leading-tight font-normal text-white pb-3">Enjoy exploring, creating, and imagining, CreativityCove, where limitless creative energy is everything.</p>
        <p class="text-xs sm:text-xs w-full tracking-tighter shadow-lg leading-tight font-normal text-white pb-6">Created At Jun 12, 2023 | Made By alifakbarr</p>
        <!-- <hr class="border border-white rounded-lg mt-2 mb-2 w-full"> -->
    </div>

    <div class="mt-12">
        <p class="text-base sm:text-lg w-full tracking-tight shadow-lg leading-tight font-bold text-white pb-2 ">Welcome to CreativityCove!</p>
        <div class="text-black bg-gray-100 rounded-lg p-6">
    ...
    <div class="mt-5">
        <p class="text-base sm:text-lg w-full tracking-tight shadow-lg leading-tight font-bold text-white pb-2 ">Philosophy About CreativityCove</p>
        <div class="text-black bg-gray-100 rounded-lg p-6">
