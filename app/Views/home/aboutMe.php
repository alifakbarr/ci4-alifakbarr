...
<div class="pt-10 sm:pt-20 pb-10 px-8">
    <div class="text-center">
        <p class="text-4xl sm:text-4xl w-full tracking-tighter shadow-lg leading-tight font-bold text-white pb-16">About Me</p>
        <div class="flex justify-center items-center pb-6">
            <img src="img/bookmark2.png" alt="Gambar Tengah" class="h-20">
        </div>
